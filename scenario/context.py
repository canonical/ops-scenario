...
class InvalidEventError(RuntimeError):
    """Raised when something is wrong with the event passed to :meth:`scenario.Context.run`"""


class ContextSetupError(RuntimeError):
    """Raised by :class:`scenario.Context` when setup fails."""


class AlreadyEmittedError(RuntimeError):
    """Raised when :meth:`scenario.Manager.run()` is called more than once."""
